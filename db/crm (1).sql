...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 25, 2018 at 09:20 AM
...
CREATE TABLE `leadassigneds` (
  ...
  `leadId` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `leadAssignStatus` tinyint(1) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `leadassigneds` (`assignId`, `assignBy`, `assignTo`, `leadId`, `created_at`, `leadAssignStatus`) VALUES
(9, 2, 2, 10, '2018-01-24 06:34:05', 1),
(10, 2, 2, 11, '2018-01-24 06:34:05', 1),
(11, 2, 2, 12, '2018-01-24 06:34:05', 1);
...
INSERT INTO `leads` (`leadId`, `statusId`, `possibilityId`, `categoryId`, `companyName`, `personName`, `designation`, `website`, `email`, `contactNumber`, `countryId`, `comments`, `contactedUserId`, `minedBy`, `created_at`) VALUES
(4, 1, 3, 1, 'test Company', 'contact', NULL, 'Test URl', 'test@tr.sdsd', '0123459', 1, NULL, NULL, 1, '2018-01-16 10:33:24'),
(5, 1, 1, 1, 'testing by Farzad', 'testing by Farzad', NULL, 'testing by Farzad', 'testing@by.Farzad', '123456789', 1, 'lol', NULL, 1, '2018-01-16 10:37:18'),
(7, 1, 1, 1, 'asd', 'sdsds', NULL, 'dasddded', 'gk@kjk.dsd', '01324729264', 1, NULL, NULL, 1, '2018-01-16 11:24:53'),
(8, 1, 3, 2, 'today company', 'test', NULL, 'today company', 'today@company.com', '01264978', 2, 'commmm', NULL, 1, '2018-01-17 07:48:49'),
(10, 2, 2, 1, 'This lead is From Today', 'Group', NULL, 'www.ascb.com', 'farzad@yahoo.com', '0165989484', 2, 'testing 123', NULL, 1, '2018-01-18 10:29:16'),
(11, 2, 1, 1, 'Lead By Farzad', 'Friday', NULL, 'www.friday.com', 'friday@gmail', '+1223456464', 1, 'sdsdsd', NULL, 1, '2018-01-19 12:33:02'),
(12, 2, 3, 1, 'Saturday Lead', 'Mr. Sat', 'Manager', 'done.com', 'saturday@yahoo.com', '00000', 1, 'Done', NULL, 1, '2018-01-20 04:34:25'),
(13, 2, 4, 2, 'Updated', 'Masud Rana', 'Project Manager', 'www.abcd.com.bd', 'masudrana@gmail.com', '01718447860', 2, 'higher priority', NULL, 1, '2018-01-22 08:11:48');
...
(1, '11-111-11', 1, 'admin@admin.com', '$2y$10$IXO8JVVc6B8Y3FB3FUy2SOPZ.HSFAfRDsJSQs/GCOKJmY2sAGZjEW', 123455689, 'Admin', 'Rahman', NULL, '01624729264', '1.11-111-11.jpg', '1995-08-26', 'M', 1, 2, '759V7lKXqG3E9BaVMeEPSH9cQAI5xJLnhIDpWm0sqiWdWVc2eyKaRgADmIBD', '2018-01-16 10:24:38', '2018-01-25 06:47:41'),
(2, '22-222-22', 2, 'farzad@test.com', '$2y$10$wbcUxeliREOp9V9HxcCYR.E21yaEwGrC1hC2ziFOK.wIrTqXZibn6', NULL, 'Farzad', 'Rahman', NULL, '01624796565', NULL, '2018-11-01', 'M', 1, 2, 'bO5DtKB3AhE1a6AfMWfUFlzvKFKGxVM7Jt7uMXkj4XgXFfVjFLtpZGnbHuwF', '2018-01-17 11:39:52', '2018-01-25 06:47:41'),
(3, '123456', 2, 'a1234@yahoo.com', '$2y$10$Op0O6XF/xxKn5bQXMK.9TePO9gGF8796BT0uVXAr4jjCDsSCGypU.', NULL, 'alamin', 'alamin', NULL, '01345987989', '', '2018-01-11', 'M', 1, 2, NULL, '2018-01-22 06:33:03', '2018-01-25 06:47:41');
...
INSERT INTO `workprogress` (`progressId`, `callingReport`, `response`, `leadId`, `progress`, `userId`, `comments`, `created_at`) VALUES
(10, 6, 'done', 11, 'Test job', 2, 'commented', '2018-01-24 06:35:28'),
(11, 5, 'done', 11, 'Test job', 2, 'done this work', '2018-01-25 06:23:14');
...
--
ALTER TABLE `leadassigneds`
  MODIFY `assignId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
...
--
ALTER TABLE `possibilities`
  MODIFY `possibilityId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `possibilitychanges`
--
ALTER TABLE `possibilitychanges`
  MODIFY `changeId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
