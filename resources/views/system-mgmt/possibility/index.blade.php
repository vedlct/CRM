                    ...
                    <form method="POST" action="{{ route('possibility.destroy', ['id' => $possibility->possibilityId]) }}" onsubmit = "return confirm('Are you sure?')">
                        <input type="hidden" name="_method" value="DELETE">
							...
							<a href="#edit_modal" data-toggle="modal" class="btn btn-info btn-sm"
							   ...
							   data-possibility-type="{{$possibility->type}}"">
...
@endsection
		...
		$('#create_modal').on('show.bs.modal', function(e) {
			...
			var possibilityId = $(e.relatedTarget).data('possibility-id');
			var possibilityName = $(e.relatedTarget).data('possibility-name');
			
			//populate the textbox
			$(e.currentTarget).find('input[name="possibilityId"]').val(possibilityId);
			$(e.currentTarget).find('input[name="possibilityName"]').val(possibilityName);
